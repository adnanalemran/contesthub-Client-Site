...
const TopContest = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/contestTop6`)
      .then((res) => {
        setContest(res.data);
      })
      .catch((error) => {
  ...
  return (
    <div className="pt-16">
      ...
      <h4 className="text-2xl text-blue-500 text-center">Top #6 Contest</h4>
      <h2 className="text-5xl font-bold text-center">Top popular Contest </h2>
